...
function initStartScreen() {
    ...
    var a = {oImgData: assetLib.getData("playBut"),aPos: [canvas.width / 2, 370]},/*更多游戏，可更改为排行榜什么的*/ b = {oImgData: assetLib.getData("moreGamesBut"),aPos: [canvas.width / 2, 480]};
    userInput.addHitArea("startGame", butEventHandler, null, {type: "image",oImageData: a.oImgData,aCentrePos: a.aPos}),/*更多游戏，可更改为排行榜什么的*/ userInput.addHitArea("moreGames", butEventHandler, null, {type: "image",oImageData: b.oImgData,aCentrePos: b.aPos});
    var c = new Array(a, b);
...
function initGameOver() {  //游戏结束，这里可以ajax提交成绩
