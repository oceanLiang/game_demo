...
(function() {
    ...
    var Rn = function(e) {
        ...
        Kn.addButton(this.root, Kn.halfWidth - 75, Kn.halfHeight + 170, "home_btn", function() { //返回首页
        ...
        Kn.addButton(this.root, Kn.halfWidth + 75, Kn.halfHeight + 170, "replay_btn", function() {  //再来一次
    ...
    var Xn = function() {
        ...
        e.y.animateTo(Kn.halfHeight - 90, 1, F.bounceOut);
        
        //e = Kn.addLabel(this.root, Kn.halfWidth + 40, Kn.height + 100, "" + o.HI_SCORE, 1.2, 0, !0)._compMap.Sprite_0;
        e = Kn.addLabel(this.root, Kn.halfWidth + 40, Kn.height + 100, "" , 1.2, 0, !0)._compMap.Sprite_0;
        
         Kn.addButton(e.owner, 180, 15, "paihang", function() {  //排行榜
            document.getElementById('paihang').style.display='block';
            var postData = {
			    "action": "top",
			   }
			...
			xhr.onreadystatechange = function(){
			    ...
			    if (XMLHttpReq.readyState == 4) {
			        if (XMLHttpReq.status == 200) {
			            var text = unescape(XMLHttpReq.responseText);
			            var obj = eval('(' + text + ')');
			 			...
			 			setTimeout(
			 				...
			 				,'2000');
			 			 document.getElementById('ranking_list').innerHTML =obj.res;
						 document.getElementById('ranking_title').innerHTML ='我的排行：'+obj.myrank;
      ...
      Kn.addButton(e.owner, -240, 15, "info", function() {  //我的信息
           	 //alert('我的信息');
           	 location.href="../jfdh/index.php?action=1";
        }, "", 1, 1)._compMap.Sprite_0;
        
       
        e = Kn.addButton(this.root, Kn.halfWidth, Kn.height - 200, "play_btn2", function() { //开始游戏
            Kn.goToScene((new Un(0)).root)
        ...
        Kn.addButton(this.root, Kn.width - 80, 90, "sound_on_btn", function() {  //声音开关
            $n.muteAll()
        }, "sound_off_btn", 1, 1)
    };
