...
~function(bt) {
    bt.URL = {
        root: "//yx8.com/?baodachanpingou",
        getMoreGame: function() {
            bt.dc("more");
            return "http://yx8.com/?baodachanpingou"
        },
        getConcern: function() {
            return "http://mp.weixin.qq.com/s?__biz=MjM5MDAzNzk4NQ==&mid=201406153&idx=1&sn=795d99af3bad9dd9472591b8cd3438af#rd"
        },
...
~function(bt) {
    ...
    var loading = function(d, e) {
        if (d > 0x0 && !b) {
            ...
            b.html('<table><tr><td><img class="bt-img" src="100913_1323.jpg" /><div class="bt-text"></div></td></tr></table>');
...
~function(bt) {
    ...
    onlyH.prototype = {
        ...
        getScreenOption: function() {
            return {
                id: "bt-h-scrren",
                html: "<table><tr><td><img class='bt-h-screen-img' src='100405_7462.jpg' /></td></tr></table>",
                time: 0x0,
                lockId: "bt-hide-lock"
            }
        },
    ...
    onlyH.prototype, {
        ...
        getScreenOption: function() {
            return {
                id: "bt-v-scrren",
                html: "<table><tr><td><img class='bt-v-screen-img' src='100433_5472.jpg' /></td></tr></table>",
                time: 0x0,
                lockId: "bt-hide-lock"
            }
        }
...
~function(bt) {
    ...
    function tip() {
        var c = bt.advertisement({
            id: b,
            html: "<img class='bt-play-share-tip-img' src='100500_5390.jpg' />",
            time: 0x0
        });
        c.show();
        setTimeout(function() {
